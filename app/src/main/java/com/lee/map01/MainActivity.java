...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout topBtn;
    @BindView(R.id.btn_jiudian)
    TextView btnJiudian;
    @BindView(R.id.btn_yiyuan)
    TextView btnYiyuan;
    @BindView(R.id.btn_yinhang)
    TextView btnYinhang;
...
//                PoiSearch             
    ...
    @OnClick({R.id.map_normal, R.id.map_satellite, R.id.map_blank, R.id.map_traffic, R.id.map_heat, R.id.location, R
            .id.btn_sreach, R.id.btn_food, R.id.btn_jiayou, R.id.btn_jiudian, R.id.btn_yinhang, R.id.btn_yiyuan})
