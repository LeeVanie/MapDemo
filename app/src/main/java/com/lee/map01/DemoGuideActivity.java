...
import com.lee.map01.utils.EventHandler;
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode)
                        bundle.getSerializable(RoutePlanActivity.ROUTE_PLAN_NODE);
            }
        }
...
//        );
    ...
    private void showOverlay() {
        BNOverlayItem item =
                new BNOverlayItem(2563047.686035, 1.2695675172607E7, BNOverlayItem.CoordinateType.BD09LL);
                ...
                public void handleMessage(android.os.Message msg) {
                    if (msg.what == MSG_RESET_NODE) {
                        ...
                        mRouteGuideManager.resetEndNodeInNavi(
                                new BNRoutePlanNode(Common.Sreach_Longitude, Common.Sreach_Latitude, Common.Location_End,
